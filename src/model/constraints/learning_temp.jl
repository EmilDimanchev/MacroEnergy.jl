function add_learning!(system::System, model::Model, period_idx::Int, settings::NamedTuple)
    ```
    Implements endogenous technological learning constraints. The main output is the endogenous investment cost term, called "endog_annualized_investment_cost_times_newcapacity", which is used in edge.jl for any learning technologies
