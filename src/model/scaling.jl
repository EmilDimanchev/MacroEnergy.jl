...
const _EDGE_SCALABLE_FIELDS = Symbol[
    ...
    :startup_cost, :init_cumul_capacity, :max_cumul_capacity, :interconnect_annuity, :capacity_in_progress_init
]
...
const _STORAGE_SCALABLE_FIELDS = Symbol[
    :capacity_size, :existing_capacity, :max_capacity, :min_capacity,
    :max_new_capacity, :min_retired_capacity,
    :investment_cost, :fixed_om_cost, :variable_om_cost, :annualized_investment_cost,:init_cumul_capacity, :max_cumul_capacity, :interconnect_annuity, :capacity_in_progress_init
]
