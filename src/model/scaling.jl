...
function attributes_to_scale(e::Edge)
    return [:capacity_size, :existing_capacity, :fixed_om_cost, :investment_cost, :annualized_investment_cost, :max_capacity, :min_capacity, :cumulative_external_capacity, :max_cumul_capacity, :min_retired_capacity, :variable_om_cost]
end

function attributes_to_scale(e::EdgeWithUC)
    return [:capacity_size, :existing_capacity, :fixed_om_cost, :investment_cost, :annualized_investment_cost, :max_capacity, :min_capacity, :cumulative_external_capacity, :max_cumul_capacity, :min_retired_capacity, :variable_om_cost, :startup_cost]
end

function attributes_to_scale(g::AbstractStorage)
    return [:capacity_size,:existing_capacity,:fixed_om_cost,:investment_cost, :annualized_investment_cost, :max_capacity,:min_capacity, :cumulative_external_capacity, :max_cumul_capacity, :min_retired_capacity]
end
